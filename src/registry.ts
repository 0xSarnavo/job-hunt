...
export const PORTALS: Portal[] = [
  ...
  { slug: "sequoia-jobs", name: "Sequoia Jobs board", url: "https://jobs.sequoiacap.com/jobs", kind: "VC_BOARD", status: "ACTIVE", gives: "Sequoia portfolio jobs (rendered fetch + free-model parse)" },
  { slug: "lightspeed-jobs", name: "Lightspeed Jobs board", url: "https://jobs.lsvp.com/jobs", kind: "VC_BOARD", status: "ACTIVE", gives: "Lightspeed portfolio jobs (rendered fetch + free-model parse)" },
